...
namespace lojaroupas.UI
{
    public class Clientes
    {
        ...
        static void AlterarCliente()
        {
            ...
            Console.Write("Digite o ID do cliente para alterar: ");
            int id = int.Parse(Console.ReadLine());
            Clientes cliente = clientes.Find(c => c.Id == id);
            if (cliente == null)
            {
        ...
        static void RealizarVenda()
        {
            ...
            do
            {
                ...
                {
                    // Selecionar o produto para comprado
        ...
        static Clientes SelecionarCliente()
        {
            Console.Clear();
            ...
            {
                Console.WriteLine("Digite de novo! ID incorreto!");
                Console.Write("Digite o ID do cliente ou 0 para voltar: ");
            }
            if (idCliente == 0)
            {
